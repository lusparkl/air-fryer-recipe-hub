...
class EatingWell(Abstract_scraper):
    def get_name(self):
    ...
    def get_time_details(self):
        ...
        overall_time = recipe_time_details[1].find("div", class_ = "mm-recipes-details__value").text
    ...
    def get_nutrion_facts(self):
        ...
        calories = nutrion_facts_to_int(nutrion_facts[0])
